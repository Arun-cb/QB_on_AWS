...
def fnGetTableData(request):
    ...
    if db_type == 'MYSQL':
        ...
        # Fetch all table names and create a list of dictionaries
        table_names = [{"table_id": idx, "table_name": table[1]}
                       for idx, table in enumerate(datacursor.fetchall(), start=1)]
    ...
    if db_type == 'MYSQL':
        ...
        try:
            ...
            if query:
                ...
                print("code info",data_type_code,"data :",data_types_str,"info :",columns_info)
        ...
        try:
            ...
            if query:
                ...
                print("Oracle code info",data_type_code,"data :",data_types_str,"info :",columns_info)
        ...
        try:
            ...
            if query:
                ...
                # Convert results to key-value pairs
                data = [dict(zip(columns, row)) for row in results]
                print("Snowflake code info",data_type_code,"data :",data_types_str,"info :",columns_info)
        ...
        for aggregatedColumnData in data:
            if aggregatedColumnData['selectedColumn'] == column_name and aggregatedColumnData['selectedTable'] == table_name:
                ...
                if "id" in aggregatedColumnData:
                    print("having id in aggregatedColumnData")
                    ...
                    if queryAggregateserilizer.is_valid():
                        queryAggregateserilizer.save()
                        # fn_ins_upd_join_data(data, table_id, def_query_id, created_by, last_updated_by)
                    else:
