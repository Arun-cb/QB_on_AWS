...
def get_ydata_profiling_report(request):
    ...
    customised_data = connnectionrequestdata["customdata"]
    correlation_data = connnectionrequestdata["customdata"][1]["correlations"]
    ...
    report = ProfileReport(df, title= query_name,
                ...
                missing_diagrams={
                    "heatmap": True, 
                    # if customised_data[2]["value"] == True and customised_data[2]["type"] == "heatmap" else False,
                    "bar": True ,
                    # if customised_data[2]["value"] == True and customised_data[2]["type"] == "bar" else False,
                    "matrix": True
                    # True if customised_data[2]["value"] == True and customised_data[2]["type"] == "matrix" else False
                },
                duplicates=None,
                # samples= None,
            )
